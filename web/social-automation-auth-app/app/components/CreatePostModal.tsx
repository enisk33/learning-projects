...
import { IconUpload, IconBrandFacebook, IconBrandInstagram, IconBrandTiktok, IconX } from '@tabler/icons-react';
...
export function CreatePostModal({ opened, onClose }: CreatePostModalProps) {
  ...
  // Dosya tipine göre uploadType seçeneklerini belirle
  const isVideo = file?.type.startsWith('video/');
  
  // Fotoğraf seçildiğinde uploadType'ı 'post' yap
    ...
    >
      <div className="p-6">
        ...
        <div className="space-y-4">
          ...
          {/* Yükleme Tipi - Sadece video için Reels seçeneği göster */}
          {isVideo && (
            <div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <Checkbox
                label={
                  <Group gap="xs" className="ml-2">
                    <IconBrandTiktok size={18} className="text-black" />
                    <Text className="text-sm text-gray-700">TikTok</Text>
                  </Group>
                }
                ...
                className="[&_.mantine-Checkbox-input]:!border-border [&_.mantine-Checkbox-input:checked]:!bg-black [&_.mantine-Checkbox-input:checked]:!border-black [&_.mantine-Checkbox-input]:!m-0"
              />
            </div>
          </div>
